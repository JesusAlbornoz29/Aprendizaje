...
function renderizandoElementos() {
    ...
    for (let i = 0; i < listadoNoticias.length; i++){
        MediaDeviceInfo.innerHTML += `<article>
                                        <h2>${listadoNoticias[i].titulo}</h2>
                                        <img src="${listadoNoticias[i].foto}" alt="">
...
// primero devemos guardar todas las img del documento en una variable
// const imagenes = document.querySelectorAll('.noticias article img')
// Aqui vemos cuales son
...
//     // 3( armamos los nodos dentro de donde van👇
