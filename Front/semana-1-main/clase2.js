...
function mostrarResultadoPartida(fraseResultado) {
    console.log("Resultado de la partida: " + resultadoDePartida);
    alert("Resultado de la partida: " + resultadoDePartida);
    
    if (fraseResultado === "derrota") {
      alert("Ánimo, ¡la próxima oportunidad será mejor!");
    } if (fraseResultado === "victoria") {
